...
const withCallback = (cb) => (messages) => {
  const isValid = lodash.isEmpty(messages);
...
const isValid = (geojson, cb) => {
  const result = geojsonValidation.valid(geojson, true);
...
const isPoint = (geojson, cb) => {
  const result = geojsonValidation.isPoint(geojson, true);
  return withCallback(cb)(result);
};
...
const isMultiPoint = (geojson, cb) => {
  const result = geojsonValidation.isMultiPoint(geojson, true);
  return withCallback(cb)(result);
};
...
const isLineString = (geojson, cb) => {
  const result = geojsonValidation.isLineString(geojson, true);
  return withCallback(cb)(result);
};
...
const isMultiLineString = (geojson, cb) => {
  const result = geojsonValidation.isMultiLineString(geojson, true);
  return withCallback(cb)(result);
};
...
const isPolygon = (geojson, cb) => {
  const result = geojsonValidation.isPolygon(geojson, true);
  return withCallback(cb)(result);
};
...
const isMultiPolygon = (geojson, cb) => {
  const result = geojsonValidation.isMultiPolygon(geojson, true);
  return withCallback(cb)(result);
};
...
const isGeometryCollection = (geojson, cb) => {
  const result = geojsonValidation.isGeometryCollection(geojson, true);
  return withCallback(cb)(result);
};
...
const isFeature = (geojson, cb) => {
  const result = geojsonValidation.isFeature(geojson, true);
  return withCallback(cb)(result);
};
...
const isFeatureCollection = (geojson, cb) => {
  const result = geojsonValidation.isFeatureCollection(geojson, true);
  return withCallback(cb)(result);
};
